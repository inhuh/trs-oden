...
def get_args():
    ...
    parser.add_argument('--save_folder', default='experiment-duffing-4', type=str)

    # Data variables
    parser.add_argument('--osc_params', default=(1, 0, 0.1, 0), type=tuple)
    ...
    parser.add_argument('--ls_cond', default=[['ode', 0.0, False], ['hamiltonian', 0.0, False], ['ode', 0.5, True]])
...
def run(args):
    ...
    for i in range(len(args.ls_cond)):
        ...
        function_type, lambda_trs, use_time_dep_lambda = cond[0], cond[1], cond[2]
        split_name = str(function_type) + '_' + str(lambda_trs) + '_' + str(use_time_dep_lambda)
        ...
        oden = ODENetwork(nb_object=args.nb_object, nb_coords=args.nb_coords, function_type=function_type,
                          ...
                          use_time_dep_lambda=use_time_dep_lambda, learning_rate=args.learning_rate)
