...
def get_args():
    ...
    parser.add_argument('--save_folder', default='experiment-duffing-3', type=str)

    # Data variables
    parser.add_argument('--osc_params', default=(-0.2, 0.2, 0, 0.15), type=tuple)
    parser.add_argument('--train_nb_sample', default=200, type=int)
    parser.add_argument('--train_nb_timestep', default=50, type=int)
    parser.add_argument('--train_t_span', default=(0, 5), type=tuple)
    ...
    parser.add_argument('--test_nb_timestep', default=100, type=int)
    parser.add_argument('--test_t_span', default=(0, 10), type=tuple)
    ...
    parser.add_argument('--time_augment', default=True, type=bool)
...
def run(args):
    ...
    for i in range(len(args.ls_cond)):
        ...
        plt.xlim([0, args.test_t_span[1]]), plt.ylim([-0.5, 4])
        plt.tight_layout()
